...
ImageButton.Image = "http://www.roblox.com/asset/?id=17170148384"
...
function library:AddWindow(text,keybind)
    ...
    BindButton.Position = UDim2.new(0, 530, 0, 0)
    BindButton.Size = UDim2.new(0, 100, 0, 27)
    BindButton.Font = Enum.Font.GothamSemibold
    BindButton.Text = "[ "..string.gsub(tostring("Bee Swarm Simulator"),"Enum.KeyCode.","").." ]"
    ...
    function Ui:AddTab(text)
        ...
        function uitab:AddPage()
            ...
            MainFramePage.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
            ...
            function main:AddButton(text,callback)
                ...
                btim.Image = 'http://www.roblox.com/asset/?id=17170148384'
            ...
            function main:AddDropdown(text,option,callback)
                ...
                DropImage.Image = "rbxassetid://17170148384"
                UICorner.CornerRadius = UDim.new(0, 20)
                UICorner.Parent = ImageButton
            ...
            function main:AddToggle(text,config,callback)
                ...
                Tgim.Image = 'http://www.roblox.com/asset/?id=17170148384'
...
local GeneralTab = Windows:AddTab("หน้าหลัก")
local GeneralLeft = GeneralTab:AddPage()
local GeneralRight = GeneralTab:AddPage()

------------------------------- [ General Left ] -------------------------------

GeneralLeft:AddSeperator("ฟังชั่นหลัก")
GeneralLeft:AddToggle("เก็บโทเค่นหิมะ [ วาป ]", false, function(Value)
    _G.AutoFarmWarp = Value
    spawn(function()
        while task.wait() do
            pcall(function()
                if _G.AutoFarmWarp then
                    for _, v in pairs(game:GetService("Workspace").Collectibles:GetDescendants()) do
                        if v.Name == "BackDecal" then
                            if v.Texture == "rbxassetid://6087969886" then
...
GeneralLeft:AddToggle("เก็บโทเค่นหิมะ [ บิน ]", false, function(Value)
    _G.AutoFarmFly = Value
    spawn(function()
        while task.wait() do
            pcall(function()
                if _G.AutoFarmFly then
                    for _, v in pairs(game:GetService("Workspace").Collectibles:GetDescendants()) do
                        if v.Name == "BackDecal" then
                            if v.Texture == "rbxassetid://6087969886" then
