		...
		if ac and ac.equipped then
			...
			if FastAttack then
				...
				if FastAttackType == "Fast" then
					if tick() - cooldownfastattack > 1.5 then wait() cooldownfastattack = tick() end
				end
...
local StatsPage = Stats.page()

-- [Stats Page]

local StatsLabel = StatsPage.Label({
	Title = "Stats",
})
StatsLabel.Color(Color3.fromRGB(255, 255, 255))
