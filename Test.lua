...
Title.TextColor3 = Color3.fromRGB(30, 0, 130)
...
LoadScrollbar.MouseEnter:Connect(function()
	if LoadScrollbarFocus == false then
		TweenService:Create(
			LoadScrollbar,
			TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
			{ImageColor3 = Color3.fromRGB(30, 0, 130)}
		):Play()
	end
end)
...
function Library.new()
	...
	function Library.Notifcation(options)
		...
		Button.BackgroundColor3 = Color3.fromRGB(30, 0, 130)
		...
		Line2.Name = "Line2"
		Line2.Parent = Line1
		Line2.BackgroundColor3 = Color3.fromRGB(30, 0, 130)
	...
	function LibraryTab.tab(options)
		...
		function LibraryPage.page()
				...
				ButtonToggle.MouseButton1Down:Connect(function()
					...
					if visual.toggle == false and visual.lock == true then
						...
						TweenService:Create(
							Toggle_2,
							TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{BackgroundColor3 = Color3.fromRGB(30, 0, 130)}
						):Play()
						TweenService:Create(
							Toggle_2,
							TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function LibraryFunction.Button(options)
				...
				ButtonFrame.BackgroundColor3 = Color3.fromRGB(30, 0, 130)
			...
			function LibraryFunction.Slider(options)
				...
				SliderValueFrame_2.BackgroundColor3 = Color3.fromRGB(30, 0, 130)
				...
				SliderValueFrame_3.BackgroundColor3 = Color3.fromRGB(30, 0, 130)
...
local PlayerInfo = UI.tab({
	Logo = 6022668898,
	ColorUI = Color3.fromRGB(30, 0, 130)
})
...
MainLabel.Color(Color3.fromRGB(30, 0, 130))
...
local MultiDropdownTEST = Page_Main.MultiDropdown({
	Title = "Multi Dropdown",
	Item = { "MultiDropdown", "MultiDropdown 2", "MultiDropdown 3" },
	Default = nil,
	callback = function(value)
