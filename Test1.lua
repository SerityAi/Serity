		...
		pcall(function()
			if _G.BringMonster then
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if _G.AutoFarmLevel or _G.MobAura and BringMob and v.Name == NameMon and (NameMon == "Factory Staff [Lv. 800]" or Mon == "Monkey [Lv. 14]" or Mon == "Dragon Crew Warrior [Lv. 1575]" or Mon == "Dragon Crew Archer [Lv. 1600]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
					...
					elseif _G.AutoFarmLevel or _G.MobAura and BringMob and v.Name == NameMon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 275 then
						v.HumanoidRootPart.Size = Vector3.new(50,50,50)
						v.HumanoidRootPart.CFrame = PosMon
						v.Humanoid:ChangeState(14)
						v.HumanoidRootPart.CanCollide = false
					...
					if _G.AutoFarmDevilFruitMastery and BringMonDevilFruitMastery then
						if v.Name == "Monkey [Lv. 14]" then
							if (v.HumanoidRootPart.Position - PosMonDevilFruitMastery.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
								v.HumanoidRootPart.CFrame = PosMonDevilFruitMastery
								if v.Humanoid:FindFirstChild("Animator") then
									v.Humanoid.Animator:Destroy()
								end
								sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
					...
					if _G.AutoFarmGunMastery and BringMonGunMastery then
						if v.Name == "Monkey [Lv. 14]" then
							if (v.HumanoidRootPart.Position - PosMonGunMastery.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
								v.HumanoidRootPart.CFrame = PosMonGunMastery
								if v.Humanoid:FindFirstChild("Animator") then
									v.Humanoid.Animator:Destroy()
								end
								sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
								...
								if v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									...
									repeat wait()
										if v.Humanoid.Health <= HealthMon then                                                
											Haki()
											BloxFruit()
											PosMonDevilFruitMastery = v.HumanoidRootPart.CFrame
											TP(v.HumanoidRootPart.CFrame * CFrame.new(0,10,20))
											v.HumanoidRootPart.CanCollide = false
											v.Humanoid.WalkSpeed = 0
											v.Head.CanCollide = false
											BringMonDevilFruitMastery = true
											FastAttack = false
									...
									BringMonDevilFruitMastery = false
									FastAttack = false
									UseSkill = false 
								end
							end
								...
								if v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									...
									repeat wait()
										if v.Humanoid.Health <= HealthMon then                                                
											Haki()
											Gun()
											PosMonGunMastery = v.HumanoidRootPart.CFrame
...
function CheckMaterial()
    ...
    elseif _G.SelectMaterials == "Leather" then
        MaterialMon = "Pirate"
        MaterialCFrame = CFrame.new(-1212, 5, 3917, 1, 0, 0, 0, 1, 0, 0, 0, 1)
    elseif _G.SelectMaterial == "Scrap Metal" then
        MaterialMon = "Brute"
        MaterialCFrame = CFrame.new(-1132, 15, 4293, 1, 0, 0, 0, 1, 0, 0, 0, 1)
    elseif _G.SelectMaterials == "Angel Wings" then
		MaterialMon = "Royal Soldier"
		MaterialCFrame = CFrame.new(-7827, 5607, -1705, 1, 0, 0, 0, 1, 0, 0, 0, 1)
	end
end
