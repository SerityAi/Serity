...
MiscRight:AddToggle("Semi Mink Race", _G.InfiniteAbility, function(Value)
...
MiscRight:AddToggle("Auto Active Races",_G.AutoActiveRace,function(Value)
...
MiscRight:AddToggle("Semi No Clip",_G.Noclip, function(Value)
    _G.Noclip = Value
end)
