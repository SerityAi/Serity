...
spawn(function()
	while wait() do
		pcall(function()
			if BringMob then 
			    pairs(game:GetService("Workspace").Enemies:GetChildren())
...
local Windows = library:AddWindow("Serity")
...
SelectPoint = 1
MainRight.AddSlider("Point", 1, 100, 1, function(Point)
    SelectPoint = Point
end)
spawn(function()
	while wait(.1) do
	...
	while wait(.1) do
		if _G.AutoStat then
			for i,v in pairs(_G.AutoStat) do
				...
				elseif v == "Sword" and game.Players.LocalPlayer.Data.Stats.Sword.Level.Value ~= 2550 then
					repeat game:GetService("RunService").Heartbeat:wait()
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Sword", 1)
					until game.Players.LocalPlayer.Data.Stats.Sword.Level.Value == 2550
				elseif v == "Gun" and game.Players.LocalPlayer.Data.Stats.Gun.Level.Value ~= 2550 then
					repeat game:GetService("RunService").Heartbeat:wait()
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Gun", 1)
					until game.Players.LocalPlayer.Data.Stats.Gun.Level.Value == 2550
				elseif v == "DevilFruit" and game.Players.LocalPlayer.Data.Stats["Demon Fruit"].Level.Value ~= 2550 then
					repeat game:GetService("RunService").Heartbeat:wait()
