...
ImageButton.Image = "http://www.roblox.com/asset/?id=12257997709"
...
function library:AddWindow(text,keybind)
    ...
    NameHub.TextColor3 = Color3.fromRGB(255,0,127)
    ...
    NameHub2.Text = "        Hubs x Premium 1.0"
    NameHub2.TextColor3 = Color3.fromRGB(255,0,127)
    ...
    function Ui:AddTab(text)
        ...
        function uitab:AddPage()
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = Color3.fromRGB(255,0,127)
                ...
                Sep3.BackgroundColor3 = Color3.fromRGB(255,0,127)
            ...
            function main:AddDropdown(text,option,callback)
                ...
                Dropdown.BackgroundColor3 = Color3.fromRGB(255,0,127)
            ...
            function main:AddSlider(text,min,max,set,callback)
                ...
                Slider.BackgroundColor3 = Color3.fromRGB(255,0,127)
                ...
                bar1.Name = "bar1"
                bar1.Parent = bar
                bar1.BackgroundColor3 = Color3.fromRGB(255,0,127)
                ...
                slidervalue.BackgroundColor3 = Color3.fromRGB(255,0,127)
            ...
            function main:AddTextbox(text,disappear,callback)
                ...
                Textbox.BackgroundColor3 = Color3.fromRGB(255,0,127)
                ...
                TextboxLabel.TextColor3 = Color3.fromRGB(255,0,127)
            ...
            function main:AddToggle(text,config,callback)
                ...
                Toggle.BackgroundColor3 = Color3.fromRGB(255,0,127)
                ...
                ToggleLabel.TextColor3 = Color3.fromRGB(255,0,127)
...
local MainTab = win:AddTab("User Hub")
local Main99 = MainTab:AddPage()
local Main88 = MainTab:AddPage()
...
Main99:AddSeperator("📑 Stats User 📑")
    
local locallv =Main99:AddLabel("Level")
    
spawn(function()
    while wait(.2) do
        pcall(function()
            locallv:Set("Script:".." "..game:GetService("Players").LocalPlayer.Data.Level.Value)
        end)
    end
end)

Main99:AddToggle("Auto Third Sea", _G.AutoThirdSea, function(Value)
