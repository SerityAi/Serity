		...
		pcall(function()
			while wait(.1) do
				if _G.AutoStoredFruits then
					if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rocket Fruit" or "Spin Fruit" or "Chop Fruit" or "Spring Fruit" or "Bomb Fruit" or "Smoke Fruit" or "Spike Fruit" or "Flame Fruit" or "Falcon Fruit" or "Ice Fruit" or "Sand Fruit" or "Dark Fruit" or "Diamond Fruit" or "Light Fruit" or "Rubber Fruit" or "Barrier Fruit" or "Ghost Fruit" or "Magma Fruit" or "Quake Fruit" or "Buddha Fruit" or "Love Fruit" or "Spider Fruit" or "Sound Fruit" or "Phoenix Fruit" or "Portal Fruit" or "Rumble Fruit" or "Paw Fruit" or "Blizzard Fruit" or "Gravity Fruit" or "Mammoth Fruit" or "T-Rex Fruit" or "Dough Fruit" or "Shadow Fruit" or "Venom Fruit" or "Control Fruit" or "Spirit Fruit" or "Dragon Fruit" or "Leopard Fruit" or "Kitsune Fruit") then
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Rocket-Rocket" or "Spin-Spin" or "Chop-Chop" or "Spring-Spring" or "Bomb-Bomb" or "Smoke-Smoke" or "Spike-Spike" or "Flame-Flame" or "Falcon-Falcon" or "Ice-Ice" or "Sand-Sand" or "Dark-Dark" or "Diamond-Diamond" or "Light-Light" or "Rubber-Rubber" or "Barrier-Barrier" or "Ghost-Ghost" or "Magma-Magma" or "Quake-Quake" or "Buddha-Buddha" or "Love-Love" or "Spider-Spider" or "Sound-Sound" or "Phoenix-Phoenix" or "Portal-Portal" or "Rumble-Rumble" or "Paw-Paw" or "Blizzard-Blizzard" or "Gravity-Gravity" or "Mammoth-Mammoth" or "T-Rex-T-Rex" or "Dough-Dough" or "Shadow-Shadow" or "Venom-Venom" or "Control-Control" or "Spirit-Spirit" or "Dragon-Dragon" or "Leopard-Leopard" or "Kitsune-Kitsune", game:GetService("Players").LocalPlayer.Character:FindFirstChild("Rocket Fruit" or "Spin Fruit" or "Chop Fruit" or "Spring Fruit" or "Bomb Fruit" or "Smoke Fruit" or "Spike Fruit" or "Flame Fruit" or "Falcon Fruit" or "Ice Fruit" or "Sand Fruit" or "Dark Fruit" or "Diamond Fruit" or "Light Fruit" or "Rubber Fruit" or "Barrier Fruit" or "Ghost Fruit" or "Magma Fruit" or "Quake Fruit" or "Buddha Fruit" or "Love Fruit" or "Spider Fruit" or "Sound Fruit" or "Phoenix Fruit" or "Portal Fruit" or "Rumble Fruit" or "Paw Fruit" or "Blizzard Fruit" or "Gravity Fruit" or "Mammoth Fruit" or "T-Rex Fruit" or "Dough Fruit" or "Shadow Fruit" or "Venom Fruit" or "Control Fruit" or "Spirit Fruit" or "Dragon Fruit" or "Leopard Fruit" or "Kitsune Fruit"))
					end
				end
			end
		end)
