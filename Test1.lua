...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
			...
			_G.TeleportPlayers or _G.TeleprotIsland or
...
CombatLeft:AddDropdown("Select Island", Island, function(Value)
    _G.SelectStats = Value
end)

CombatLeft:AddToggle("Teleport Island", _G.TeleprotIsland, function(Value)
	_G.TeleprotIsland = Value
    if Value == false then
		wait(0.3)
		TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
	end
    if _G.TeleprotIsland and _G.SelectStats == "Pirate Starter" then
        TP(CFrame.new(1027.58875, 19.3245106, 1367.28564, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Middle Town" then
        TP(CFrame.new(-582.941345, 6.70024586, 1713.93726, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Jungle" then
        TP(CFrame.new(-1255.14795, 11.7000084, 349.906677, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Pirate Village" then
        TP(CFrame.new(-1120.14856, 4.60001373, 3855.31763, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Desert" then
        TP(CFrame.new(1094.14587, 5.28642607, 4192.88721, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Frozen Village" then
        TP(CFrame.new(1185.63379, 7.15136719, -1143.36987, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Marine Fortless" then
        TP(CFrame.new(-4697.32324, 20.1976337, 3975.07129, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Skylands 1" then
    ...
    elseif _G.TeleprotIsland and _G.SelectStats == "Skylands 2" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-7947, 5547, -319))
    elseif _G.TeleprotIsland and _G.SelectStats == "Prison" then
        TP(CFrame.new(5032.81885, 2.3914094, 766.972168, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Colosseum" then
        TP(CFrame.new(-1332.94006, 6.35386896, -2896.56055, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Magma Village" then
        TP(CFrame.new(-5193.35498, 5.43863821, 8569.56348, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleprotIsland and _G.SelectStats == "Whirlpoll" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(3905, 14, -1941))
    elseif _G.TeleprotIsland and _G.SelectStats == "Fountain City" then
        TP(CFrame.new(5091.09619, 1.06925201, 4033.5708, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    end
end)

CombatLeft:AddButton("Instant TP", function(Value)
    _G.InstantTP = Value
    if _G.InstantTP and _G.SelectStats == "Pirate Starter" then
        TP(CFrame.new(1027.58875, 19.3245106, 1367.28564, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Middle Town" then
        TP(CFrame.new(-582.941345, 6.70024586, 1713.93726, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Jungle" then
        TP(CFrame.new(-1255.14795, 11.7000084, 349.906677, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Pirate Village" then
        TP(CFrame.new(-1120.14856, 4.60001373, 3855.31763, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Desert" then
        TP(CFrame.new(1094.14587, 5.28642607, 4192.88721, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Frozen Village" then
        TP(CFrame.new(1185.63379, 7.15136719, -1143.36987, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Marine Fortless" then
        TP(CFrame.new(-4697.32324, 20.1976337, 3975.07129, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Skylands 1" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-4608, 873, -1668))
        TP(CFrame.new(-4967.83691, 718.535278, -2623.84326, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Skylands 2" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-7947, 5547, -319))
    elseif _G.InstantTP and _G.SelectStats == "Prison" then
        TP(CFrame.new(5032.81885, 2.3914094, 766.972168, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Colosseum" then
        TP(CFrame.new(-1332.94006, 6.35386896, -2896.56055, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Magma Village" then
        TP(CFrame.new(-5193.35498, 5.43863821, 8569.56348, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.InstantTP and _G.SelectStats == "Whirlpoll" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(3905, 14, -1941))
    elseif _G.InstantTP and _G.SelectStats == "Fountain City" then
        TP(CFrame.new(5091.09619, 1.06925201, 4033.5708, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    end
end)
