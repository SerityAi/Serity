...
-- _G.AutoDeathStep
-- _G.AutoSharkmanKarate

-- Observations

-- Main Right

-- _G.AutoFarmOrderBoss

-- Items Right

-- _G.AutoFarmEctoplasm
...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
            ...
            _G.AutoFarmMaterials or _G.AutoFarmEctoplasm or
...
ItemsLeft:AddToggle("Auto Legendary Sword", _G.AutoLegendarySword, function(Value)
