				...
				elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
					...
					if game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
						...
						if game:GetService("ReplicatedStorage"):FindFirstChild(NameMon) then
						 TP(game:GetService("ReplicatedStorage"):FindFirstChild(NameMon).HumanoidRootPart.CFrame * CFrame.new(15,10,2))
						end
					end
				end
			end)
            ...
            pcall(function()
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
                        ...
                        UseSkill = false 
                        if game:GetService("ReplicatedStorage"):FindFirstChild(NameMon) then
                            TP(game:GetService("ReplicatedStorage"):FindFirstChild(NameMon).HumanoidRootPart.CFrame * CFrame.new(0,35,0))
						else
            ...
            if _G.AutoFarmGunMastery then
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
                        ...
                        StartMasteryGunMagnet = false
                        local Mob = game:GetService("ReplicatedStorage"):FindFirstChild(NameMon) 
                        if Mob then
