		...
		pcall(function()
			if BringMob then
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					...
					if _G.AutoFarmFruitMastery and BringMob then
						if v.Name == "Monkey" then
							if (v.HumanoidRootPart.Position - PosMon.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
					...
					if _G.AutoFarmGunMastery and BringMob then
						if v.Name == "Monkey" then
