		...
		pcall(function()
			if BringMob then
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if  _G.AutoFarmLevel or _G.AutoFarmDevilFruitMastery or _G.AutoFarmGunMastery or _G.MobAura and BringMob and v.Name == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
					...
					elseif _G.AutoFarmLevel or _G.AutoFarmDevilFruitMastery or _G.AutoFarmGunMastery or _G.MobAura and BringMob and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 275 then
						v.HumanoidRootPart.Size = Vector3.new(50,50,50)
						v.HumanoidRootPart.CFrame = PosMon
						v.Humanoid:ChangeState(14)
						v.HumanoidRootPart.CanCollide = false
					...
					if _G.AutoFarmEctoplasm and BringMobEctoplasm then
						if string.find(v.Name, "Ship") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - PosMonEctoplasm.Position).Magnitude <= 250 then
							v.HumanoidRootPart.Size = Vector3.new(50,50,50)
					...
					if _G.AutoRengoku and BringMobRengoku then
						if (v.Name == "Snow Lurker" or v.Name == "Arctic Warrior") and (v.HumanoidRootPart.Position - PosMonRengoku.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							v.HumanoidRootPart.Size = Vector3.new(50,50,50)
							v.Humanoid:ChangeState(14)
							v.HumanoidRootPart.CanCollide = false
							v.Head.CanCollide = false
					...
					if _G.AutoMusketeerHat and BringMobMusketeerHat then
						if v.Name == "Forest Pirate" and (v.HumanoidRootPart.Position - PosMonMusketeerHat.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							v.HumanoidRootPart.Size = Vector3.new(50,50,50)
							v.Humanoid:ChangeState(14)
							v.HumanoidRootPart.CanCollide = false
							v.Head.CanCollide = false
							v.HumanoidRootPart.CFrame = PosMonMusketeerHat
							if v.Humanoid:FindFirstChild("Animator") then
								v.Humanoid.Animator:Destroy()
							end
							sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
					...
					if _G.Auto_EvoRace and BringMobEvoRace then
						if v.Name == "Zombie" and (v.HumanoidRootPart.Position - PosMonEvoRace.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							v.HumanoidRootPart.Size = Vector3.new(50,50,50)
							v.Humanoid:ChangeState(14)
							v.HumanoidRootPart.CanCollide = false
							v.Head.CanCollide = false
							v.HumanoidRootPart.CFrame = PosMonEvoRace
							if v.Humanoid:FindFirstChild("Animator") then
								v.Humanoid.Animator:Destroy()
							end
							sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
					...
					if _G.AutoWarriorHelmet and BringMobWarriorHelmet then
						if v.Name == "Swan Pirate" and (v.HumanoidRootPart.Position - PosMonWarriorHelmet.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							v.HumanoidRootPart.Size = Vector3.new(50,50,50)
							v.Humanoid:ChangeState(14)
							v.HumanoidRootPart.CanCollide = false
							v.Head.CanCollide = false
							v.HumanoidRootPart.CFrame = PosMonWarriorHelmet
							if v.Humanoid:FindFirstChild("Animator") then
								v.Humanoid.Animator:Destroy()
							end
							sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
					...
					if _G.AutoFarmBone and BringMobBone then
					...
					if _G.AutoDoughtBoss and BringMobDoughtBoss then
					...
					if _G.AutoCandy and BringMobCandy then
...
MainLeft:AddToggle("Enabled Zou Quest", _G.EnabledZouQuest, function(Value)
    ...
    spawn(function()
        while wait() do 
            pcall(function()
                if _G.EnabledZouQuest and game.Players.LocalPlayer.Data.Level.Value >= 1500 then
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor") == nil then 
                        ...
                        wait(10)
                        local fruits = {
                            "Quake Fruit", "Human-Human: Buddha Fruit", "String Fruit", "Bird: Phoenix Fruit", 
                            "Rumble Fruit", "Paw Fruit", "Gravity Fruit", "Dough Fruit", "Venom Fruit", 
                            "Control Fruit", "Dragon Fruit", "Soul Fruit"
                        }
                        for _, fruit in ipairs(fruits) do
                            if game.Players.LocalPlayer.Character:FindFirstChild(fruit) or game.Players.LocalPlayer.Backpack:FindFirstChild(fruit) then
                    ...
                    elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ZQuestProgress", "Check") ~= 1 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Don Swan") then
                            while game:GetService("Workspace").Enemies:FindFirstChild("Don Swan") and game:GetService("Workspace").Enemies:FindFirstChild("Don Swan").Humanoid.Health > 0 and _G.EnabledZouQuest do
                                Haki()
                                EquipWeapon()
                                TP(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                v.HumanoidRootPart.CanCollide = false
                        ...
                        elseif game:GetService("ReplicatedStorage"):FindFirstChild("Don Swan") then    
                            TP(game:GetService("ReplicatedStorage"):FindFirstChild("Don Swan").HumanoidRootPart.CFrame)
                        else
                            while wait() do
                                pcall(function()
                                    Teleport()
                    ...
                    elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") ~= 3 then
                        ...
                        local BartiloQuest = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo")
                        if MyLevel >= 850 and BartiloQuest == 0 then
                            if string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and 
                               ...
                               game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                                if game:GetService("Workspace").Enemies:FindFirstChild("Swan Pirate") then
                                    while pirate and pirate.Humanoid.Health > 0 and _G.EnabledZouQuest do
                                        Haki()
                                        EquipWeapon()
                                        TP(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                        v.HumanoidRootPart.CanCollide = false
                                    ...
                                    TP(CFrame.new(872, 122, 1243))
                                end
                            else
                                wait(1)
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest", "BartiloQuest", 1)
                            end
                        elseif MyLevel >= 850 and BartiloQuest == 1 then
                            wait(0.75)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo")
                            if game.Workspace.Enemies:FindFirstChild("Jeremy") then
                                while game.Workspace.Enemies:FindFirstChild("Jeremy") and game.Workspace.Enemies:FindFirstChild("Jeremy").Humanoid.Health > 0 and _G.EnabledZouQuest do
                                    Haki()
                                    EquipWeapon()
                                    TP(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                    v.HumanoidRootPart.CanCollide = false
                            ...
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy") then
                                TP(CFrame.new(1958.5858154297, 448.94882202148, 879.37573242188))
                            else 
                                while wait() do 
                                    pcall(function()
                                        Teleport()
                        ...
                        elseif MyLevel >= 850 and BartiloQuest == 2 then
                            for i = 1, 6 do
                                local plate = game:GetService("Workspace").Map.Dressrosa.BartiloPlates["Plate" .. i]
                                firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart, plate.CFrame, 0)
                            end
                        end
                    end
                end
...
ItemsLeft:AddToggle("Auto Rengoku", _G.AutoRengoku, function(Value)
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "Swan Pirate" and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        repeat wait()
                                            Haki()
                                            EquipWeapon()
                                            PosMonWarriorHelmet = v.HumanoidRootPart.CFrame
                                            TP(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                            v.HumanoidRootPart.CanCollide = false
                                            v.Humanoid.WalkSpeed = 0
                                            v.Head.CanCollide = false
                                            v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                                            BringMobWarriorHelmet = true
                                            FastAttack = true
                                            game:GetService("VirtualUser"):CaptureController()
                                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                        until not _G.AutoWarriorHelmet or v.Humanoid.Health <= 0 or not v.Parent
                                        UnEquip()
                                        BringMobWarriorHelmet = false
                                        FastAttack = false
                                    end
                                end
                            else
...
CombatLeft:AddToggle("Teleport Island", _G.TeleportIsland, function(Value)
    ...
    if _G.TeleportIsland and SelectIsland == "Kingdom of Rose" then
        TP(CFrame.new(82.9490662, 20.2211399, 2834.98779, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Café" then
        TP(CFrame.new(-385.250916, 74.0211334, 297.388397, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Green Zone" then
        TP(CFrame.new(-2135.60938, 72.4141006, -2758.81592, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Graveyard Island" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-6508, 85, -133))
        TP(CFrame.new(-5491.56445, 49.0581512, -684.113831, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Snow Mountain" then
        TP(CFrame.new(295.549164, 400.250916, -5417.41211, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Hot and Cold" then
        TP(CFrame.new(-5886.35791, 15.763298, -4968.2207, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Cursed Ship" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(1003, 124, 32855))
    elseif _G.TeleportIsland and SelectIsland == "Ice Castle" then
        TP(CFrame.new(5440.6582, 32.7418976, -6416.79346, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    elseif _G.TeleportIsland and SelectIsland == "Forgotten Island" then
        TP(CFrame.new(-3076.56055, 239.263321, -10199.1123, 1, 0, 0, 0, 1, 0, 0, 0, 1))
    end
end)
        ...
        while wait() do
            if _G.AutoStoredFruits then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Phoenix Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird: Phoenix Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Phoenix-Phoenix",game:GetService("Players").LocalPlayer.Character:FindFirstChild("Phoenix Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird: Phoenix Fruit"))
                    end
