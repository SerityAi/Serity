		...
		pcall(function()
			if BringMob then
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					...
					if _G.AutoRengoku and BringMob then
					...
					if _G.AutoMusketeerHat and BringMob then
					...
					if _G.Auto_EvoRace and BringMob then
					...
					if _G.AutoWarriorHelmet and BringMob then
					...
					if _G.AutoFarmBone and BringMob then
					...
					if _G.AutoDoughtBoss and BringMob then
					...
					if _G.AutoCandy and BringMob then
