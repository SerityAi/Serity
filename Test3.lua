                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(NameMon) then
                                TP1(game:GetService("ReplicatedStorage"):FindFirstChild(NameMon).HumanoidRootPart.CFrame * CFrame.new(0,0,30))
                            else
                                if (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 15 then
                                    if PosMon ~= nil then
                                        TP1(PosMon * CFrame.new(0,0,30))
                                        wait(0.1)
                                        TP1(PosMon * CFrame.nes(0,0,30))
                                    else
                                        if OldPos ~= nil then
                                            TP1(OldPos.Position)
                                        end
