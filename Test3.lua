		...
		function royxpageui:royxpage(text)
			...
			function royxfunction:MultiDropdown(text,use,option,callback)
				...
				for i , v in pairs(list) do
					...
					farmtoglist.BackgroundColor3 = Color3.fromRGB(85, 170, 255)
					...
					farmtoglist2.BorderColor3 = Color3.fromRGB(85, 170, 255)
					...
					listimage.BackgroundColor3 = Color3.fromRGB(85, 170, 255)
...
local Toggle = Page:Toggle("Toggle",8543527952,true,function()
